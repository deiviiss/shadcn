  ...
  return (
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900">
        ...
        <div
          className="bg-red-900 border-8 opacity-50 hidden fixed inset-0 z-10"
          id="sidebarBackdrop"
        ></div>
        {/* content page */}
        <div
        ...
        >
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 dark:bg-slate-900 print:hidden">
